...
#             print("default box minimum, {} gt box minimum, {}".format(bboxes_default.min(), bboxes_gt.min()))
    ...
    def get_voc_2007_2012_train_data(self,is_training_data=True):
        data_sources = "/home/sundaram/SSD_tensorflow_sundaram/train_tfrecords/voc_2007_train_*.tfrecord"
    ...
    def get_voc_2007_test_data(self):
        data_sources = "/home/sundaram/SSD_tensorflow_sundaram/VOC07test_tfrecords/voc_2007_test_*.tfrecord"
    ...
    def get_voc_2007_test_data_single_object(self):
        data_sources = "/home/sundaram/SSD_tensorflow_sundaram/single_obj_tfrecords/voc_2007_test_*.tfrecord"
        num_samples = 3047
