...
class TrainModel(PrepareData):
    def __init__(self):
        ...
        self.train_dir = '/home/sundaram/SSD_tensorflow_VOC-master/models_finetune/'
...
#         self.debug_training(sess,global_step)
    ...
    def run(self):
        ...
        self.train_dir = '/home/sundaram/SSD_tensorflow_VOC-master/models_temp_0.001/'
        
        
        self.checkpoint_path = '/home/sundaram/SSD_tensorflow_VOC-master/models_temp_0.001/model.ckpt-80000'
        ...
        if self.fine_tune_vgg16:  
            ...
            self.train_dir = '/home/sundaram/SSD_tensorflow_VOC-master/models_finetune/'
            self.checkpoint_path =  '/home/sundaram/SSD_tensorflow_VOC-master/models_finetune/model.ckpt-490756'
            self.checkpoint_exclude_scopes = None
