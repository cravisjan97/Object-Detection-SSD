...
#         print_filename_op = tf.Print(filename, [filename], "input images: ")
    ...
    def parse_param(self):
        ...
        parser.add_argument('-t', '--train',  help='evaluate against train dataset',  action='store_true')
        ...
        self.checkpoint_path = '/home/sundaram/SSD_tensorflow_sundaram/models_finetune/model.ckpt-436230'
	'''
	...
	self.eval_train = False	# Evaluates either the training set or testing set
